...
function charity_ngo_breadcrumbs() {
	global $post;
	
	
	$homeLink = esc_url(home_url('/'));
	
	$homeText = esc_attr__('Home', 'charity-ngo');
	...
	if (is_single()) {
		...
		echo '<span>' . esc_html__('Search results for', 'charity-ngo') . ": '" . esc_html(get_search_query()) . "'</span>";
		...
		if (is_tax('post_format', 'post-format-gallery')) {
			echo '<span>' . esc_html_x('Galleries', 'post format archive title', 'charity-ngo') . '</span>';
		} elseif (is_tax('post_format', 'post-format-image')) {
			echo '<span>' . esc_html_x('Images', 'post format archive title', 'charity-ngo') . '</span>';
		} elseif (is_tax('post_format', 'post-format-video')) {
			echo '<span>' . esc_html_x('Videos', 'post format archive title', 'charity-ngo') . '</span>';
		} elseif (is_tax('post_format', 'post-format-audio')) {
			echo '<span>' . esc_html_x('Audio', 'post format archive title', 'charity-ngo') . '</span>';
		}
		...
		echo '<span>' . esc_html__('No breadcrumbs', 'charity-ngo') . '</span>';
	}
}
