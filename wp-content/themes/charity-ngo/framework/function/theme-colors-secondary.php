...
function charity_ngo_theme_colors_secondary() {
...
/***************** Start {$title} CMSMASTERS Donations Color Scheme Rules ******************/
	...
	{$rule}.cmsmasters_donations .donation .cmsmasters_donation_campaign a {
		" . cmsmasters_color_css('color', $cmsmasters_option['charity-ngo' . '_' . $scheme . '_color']) . "
	}
	/* Finish Main Content Font Color */
	
	
	/* Start Primary Color */
	{$rule}.header_mid .header_donation_but .cmsmasters_button:hover,
	...
	{$rule}.cmsmasters_donations .donation .cmsmasters_donation_title a:hover {
		" . cmsmasters_color_css('color', $cmsmasters_option['charity-ngo' . '_' . $scheme . '_link']) . "
	}
	...
	{$rule}.opened-article > .campaign .campaign_meta_wrap .cmsmasters_campaign_donate_button .button {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['charity-ngo' . '_' . $scheme . '_link']) . "
	}
	...
	{$rule}.cmsmasters_donations .donation .cmsmasters_img_rollover_wrap:hover .cmsmasters_img_rollover {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['charity-ngo' . '_' . $scheme . '_link']) . ", 0.85);
	}
	
	{$rule}.opened-article > .campaign .campaign_meta_wrap .cmsmasters_campaign_donate_button .button {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['charity-ngo' . '_' . $scheme . '_link']) . "
	}
	...
	{$rule}.cmsmasters_post_comments:before {
		" . cmsmasters_color_css('color', $cmsmasters_option['charity-ngo' . '_' . $scheme . '_hover']) . "
	}
	...
	{$rule}.cmsmasters_donations .donation .cmsmasters_donation_title a {
		" . cmsmasters_color_css('color', $cmsmasters_option['charity-ngo' . '_' . $scheme . '_heading']) . "
	}
	...
	{$rule}.cmsmasters_donations .donation .cmsmasters_img_rollover_wrap .cmsmasters_open_post_link {
		" . cmsmasters_color_css('color', $cmsmasters_option['charity-ngo' . '_' . $scheme . '_bg']) . "
	}
	
	{$rule}.opened-article > .campaign .campaign_meta_wrap .cmsmasters_campaign_donate_button .button:hover {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['charity-ngo' . '_' . $scheme . '_bg']) . "
	}
	...
	{$rule}.header_mid .header_donation_but .cmsmasters_button {
		" . cmsmasters_color_css('color', $cmsmasters_option['charity-ngo' . '_' . $scheme . '_alternate']) . "
	}
	...
	{$rule}.campaign_meta_wrap .cmsmasters_campaign_donate_button {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['charity-ngo' . '_' . $scheme . '_alternate']) . "
	}
	...
	{$rule}.cmsmasters_donations .donation .cmsmasters_donation_footer {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['charity-ngo' . '_' . $scheme . '_border']) . "
	}
...
/***************** Start {$title} WooCommerce Color Scheme Rules ******************/
	...
	/* Start Highlight Color */
	{$rule}#page .select2-container .select2-choice,
	...
	{$rule}.link_hover_color {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['charity-ngo' . '_' . $scheme . '_hover']) . "
	}
	/* Finish Highlight Color */
	...
	{$rule}.widget_price_filter .ui-slider-handle {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['charity-ngo' . '_' . $scheme . '_heading']) . "
	}
	/* Finish Headings Color */
	...
	{$rule}.comment-form-rating .stars > span {
		" . cmsmasters_color_css('color', $cmsmasters_option['charity-ngo' . '_' . $scheme . '_border']) . "
	}
	...
	{$rule}.widget_price_filter .price_slider {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['charity-ngo' . '_' . $scheme . '_border']) . "
	}
	/* Finish Borders Color */
...
/***************** Start {$title} Events Color Scheme Rules ******************/
	...
	{$rule}.tribe-mini-calendar tbody .tribe-events-past a:before {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['charity-ngo' . '_' . $scheme . '_hover']) . "
	}
	/* Finish Highlight Color */
	...
	{$rule}.tribe-events-tooltip:after {
		" . cmsmasters_color_css('border-top-color', $cmsmasters_option['charity-ngo' . '_' . $scheme . '_bg']) . "
	}
	
	{$rule}.tribe-events-grid .tribe-week-event.tribe-events-week-allday-single .tribe-events-tooltip:after,
	{$rule}.recurringinfo .recurring-info-tooltip:after {
		" . cmsmasters_color_css('border-bottom-color', $cmsmasters_option['charity-ngo' . '_' . $scheme . '_bg']) . "
	}
	...
	{$rule}.tribe-events-grid .tribe-events-day-column-5 .tribe-events-tooltip:after {
		" . cmsmasters_color_css('border-left-color', $cmsmasters_option['charity-ngo' . '_' . $scheme . '_bg']) . "
	}
	
	{$rule}.tribe-events-grid .tribe-week-event .tribe-events-tooltip:after {
		" . cmsmasters_color_css('border-right-color', $cmsmasters_option['charity-ngo' . '_' . $scheme . '_bg']) . "
	}
	...
	{$rule}.cmsmasters_event_day, 
	{$rule}.cmsmasters_event_big_date .cmsmasters_event_big_date_wrap, 
	...
	{$rule}.tribe-events-tooltip:before {
		" . cmsmasters_color_css('border-top-color', $cmsmasters_option['charity-ngo' . '_' . $scheme . '_border']) . "
	}
	
	{$rule}.tribe-events-grid .tribe-week-event .tribe-events-tooltip:before {
		" . cmsmasters_color_css('border-right-color', $cmsmasters_option['charity-ngo' . '_' . $scheme . '_border']) . "
	}
	...
	{$rule}.tribe-events-grid .tribe-events-day-column-5 .tribe-events-tooltip:before {
		" . cmsmasters_color_css('border-left-color', $cmsmasters_option['charity-ngo' . '_' . $scheme . '_border']) . "
	}
	
	{$rule}.tribe-events-grid .tribe-week-event.tribe-events-week-allday-single .tribe-events-tooltip:before,
	{$rule}.recurringinfo .recurring-info-tooltip:before {
		" . cmsmasters_color_css('border-bottom-color', $cmsmasters_option['charity-ngo' . '_' . $scheme . '_border']) . "
	}
	/* Finish Borders Color */
...
/***************** Start Header Middle Color Scheme Rules ******************/
	...
	.header_mid select,
	.header_mid option {
		" . cmsmasters_color_css('color', $cmsmasters_option['charity-ngo' . '_header_mid_color']) . "
	}
	...
	.header_mid button:hover {
		" . cmsmasters_color_css('color', $cmsmasters_option['charity-ngo' . '_header_mid_link']) . "
	}
	...
	.header_mid button {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['charity-ngo' . '_header_mid_link']) . "
	}
	...
	.header_mid input[type=button], 
	.header_mid button {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['charity-ngo' . '_header_mid_link']) . "
	}
	...
	.cmsmasters_dynamic_cart:hover .cmsmasters_dynamic_cart_button {
		" . cmsmasters_color_css('color', $cmsmasters_option['charity-ngo' . '_header_mid_hover']) . "
	}
	...
	.header_mid input[type=button]:hover,   
	.header_mid button:hover {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['charity-ngo' . '_header_mid_hover']) . "
	}
	...
	.header_mid select:focus {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['charity-ngo' . '_header_mid_hover']) . "
	}
	...
	.header_mid select,
	.header_mid option {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['charity-ngo' . '_header_mid_bg']) . "
	}
	...
	.header_mid input[type=button], 
	.header_mid button {
		" . cmsmasters_color_css('color', $cmsmasters_option['charity-ngo' . '_header_mid_bg_scroll']) . "
	}
	
	.header_mid.header_mid_scroll {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['charity-ngo' . '_header_mid_bg_scroll']) . "
	}
	...
	.header_mid select,
	.header_mid option {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['charity-ngo' . '_header_mid_border']) . "
	}
	...
	.header_mid ::selection {
		" . cmsmasters_color_css('background', $cmsmasters_option['charity-ngo' . '_header_mid_link']) . "
		" . cmsmasters_color_css('color', $cmsmasters_option['charity-ngo' . '_header_mid_bg']) . "
	}
...
/***************** Start Header Bottom Color Scheme Rules ******************/
	...
	.header_bot select,
	.header_bot option {
		" . cmsmasters_color_css('color', $cmsmasters_option['charity-ngo' . '_header_bot_color']) . "
	}
	...
	.header_bot a {
		" . cmsmasters_color_css('color', $cmsmasters_option['charity-ngo' . '_header_bot_link']) . "
	}
	...
	.header_bot .search_wrap.search_opened .search_bar_wrap .search_button button {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['charity-ngo' . '_header_bot_link']) . "
	}
	...
	.header_bot a:hover {
		" . cmsmasters_color_css('color', $cmsmasters_option['charity-ngo' . '_header_bot_hover']) . "
	}
	...
	.header_bot .search_wrap .search_bar_wrap .search_button button {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['charity-ngo' . '_header_bot_hover']) . "
	}
	
	.header_bot input:not([type=submit]):not([type=button]):not([type=radio]):not([type=checkbox]):focus,
	.header_bot textarea:focus,
	.header_bot select:focus {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['charity-ngo' . '_header_bot_hover']) . "
	}
	...
	.header_bot button, 
	.header_bot .search_wrap .search_bar_wrap .search_button button {
		" . cmsmasters_color_css('color', $cmsmasters_option['charity-ngo' . '_header_bot_bg']) . "
	}
	...
	.header_bot select,
	.header_bot option {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['charity-ngo' . '_header_bot_bg']) . "
	}
	...
	.header_bot.header_bot_scroll {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['charity-ngo' . '_header_bot_bg_scroll']) . "
	}
	...
	.header_bot select,
	.header_bot option {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['charity-ngo' . '_header_bot_border']) . "
	}
	...
	.header_bot ::selection {
		" . cmsmasters_color_css('background', $cmsmasters_option['charity-ngo' . '_header_bot_link']) . "
		" . cmsmasters_color_css('color', $cmsmasters_option['charity-ngo' . '_header_bot_bg']) . "
	}
...
/***************** Start Navigation Color Scheme Rules ******************/
	...
	@media only screen and (min-width: 1025px) {
		ul.navigation > li > a {
			" . cmsmasters_color_css('color', $cmsmasters_option['charity-ngo' . '_navigation_title_link']) . "
		}
	}
	...
	@media only screen and (min-width: 1025px) {
		...
		ul.navigation > li:hover > a .nav_subtitle {
			" . cmsmasters_color_css('color', $cmsmasters_option['charity-ngo' . '_navigation_title_link_hover']) . "
		}
	}
	...
	@media only screen and (min-width: 1025px) {
		...
		ul.navigation > li > a .nav_tag {
			" . cmsmasters_color_css('color', $cmsmasters_option['charity-ngo' . '_navigation_title_link_current']) . "
		}
	}
	...
	@media only screen and (min-width: 1025px) {
		ul.navigation > li > a .nav_subtitle {
			" . cmsmasters_color_css('color', $cmsmasters_option['charity-ngo' . '_navigation_title_link_subtitle']) . "
		}
		
		ul.navigation > li > a .nav_tag {
			" . cmsmasters_color_css('background-color', $cmsmasters_option['charity-ngo' . '_navigation_title_link_subtitle']) . "
		}
		
		ul.navigation > li > a .nav_tag:before {
			" . cmsmasters_color_css('border-color', $cmsmasters_option['charity-ngo' . '_navigation_title_link_subtitle']) . "
		}
	}
	...
	@media only screen and (min-width: 1025px) {
		...
		ul.navigation > li.current-menu-item > a {
			" . cmsmasters_color_css('background-color', $cmsmasters_option['charity-ngo' . '_navigation_title_link_bg']) . "
		}
	}
	...
	@media only screen and (min-width: 1025px) {
		ul.navigation > li:hover:before {
			" . cmsmasters_color_css('background-color', $cmsmasters_option['charity-ngo' . '_navigation_title_link_bg_hover']) . "
		}
	}
	...
	@media only screen and (min-width: 1025px) {
		...
		ul.navigation > li.menu-item.current-menu-ancestor:before {
			" . cmsmasters_color_css('background-color', $cmsmasters_option['charity-ngo' . '_navigation_title_link_bg_current']) . "
		}
	}
	...
	@media only screen and (min-width: 1025px) {
		ul.navigation > li:before {
			" . cmsmasters_color_css('background-color', $cmsmasters_option['charity-ngo' . '_navigation_title_link_border']) . "
		}
	}
	...
	.navigation li .menu-item-mega-description-container * {
		" . cmsmasters_color_css('color', $cmsmasters_option['charity-ngo' . '_navigation_dropdown_text']) . "
	}
	...
	@media only screen and (max-width: 1024px) {
		ul.navigation {
			" . cmsmasters_color_css('background-color', $cmsmasters_option['charity-ngo' . '_navigation_dropdown_bg']) . "
		}
	}
	...
	.cmsmasters_dynamic_cart .widget_shopping_cart_content:before {
		" . cmsmasters_color_css('border-bottom-color', $cmsmasters_option['charity-ngo' . '_navigation_dropdown_bg']) . "
	}
	...
	@media only screen and (min-width: 1025px) {
		ul.navigation ul, 
		ul.navigation .menu-item-mega-container {
			" . cmsmasters_color_css('border-color', $cmsmasters_option['charity-ngo' . '_navigation_dropdown_border']) . "
		}
	}
	...
	.navigation li a {
		" . cmsmasters_color_css('color', $cmsmasters_option['charity-ngo' . '_navigation_dropdown_link']) . "
	}
	...
	.navigation li a .nav_tag {
		" . cmsmasters_color_css('color', $cmsmasters_option['charity-ngo' . '_navigation_dropdown_link_hover']) . "
	}
	...
	.navigation li a .nav_subtitle {
		" . cmsmasters_color_css('color', $cmsmasters_option['charity-ngo' . '_navigation_dropdown_link_subtitle']) . "
	}
	
	.navigation li a .nav_tag {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['charity-ngo' . '_navigation_dropdown_link_subtitle']) . "
	}
	...
	.navigation li > a:hover,
	.navigation li.current-menu-item > a {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['charity-ngo' . '_navigation_dropdown_link_highlight']) . "
	}
	...
	.navigation li {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['charity-ngo' . '_navigation_dropdown_link_border']) . "
	}
...
/***************** Start Header Top Color Scheme Rules ******************/
	...
	.header_top {
		" . cmsmasters_color_css('color', $cmsmasters_option['charity-ngo' . '_header_top_color']) . "
	}
	...
	.header_top .header_top_but.opened {
		" . cmsmasters_color_css('color', $cmsmasters_option['charity-ngo' . '_header_top_link']) . "
	}
	
	.header_top .responsive_top_nav:before, 
	.header_top .responsive_top_nav:after, 
	.header_top .responsive_top_nav span {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['charity-ngo' . '_header_top_link']) . "
	}
	...
	.header_top .header_top_but {
		" . cmsmasters_color_css('color', $cmsmasters_option['charity-ngo' . '_header_top_hover']) . "
	}
	...
	.header_top {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['charity-ngo' . '_header_top_bg']) . "
	}
	...
	.header_top_outer,
	.header_top .header_top_but {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['charity-ngo' . '_header_top_border']) . "
	}
	...
	.header_top ::selection {
		" . cmsmasters_color_css('background', $cmsmasters_option['charity-ngo' . '_header_top_link']) . "
		" . cmsmasters_color_css('color', $cmsmasters_option['charity-ngo' . '_header_top_bg']) . "
	}
...
/***************** Start Header Top Navigation Color Scheme Rules ******************/
	...
	@media only screen and (min-width: 1025px) {
		ul.top_line_nav > li > a {
			" . cmsmasters_color_css('color', $cmsmasters_option['charity-ngo' . '_header_top_title_link']) . "
		}
	}
	...
	@media only screen and (min-width: 1025px) {
		...
		ul.top_line_nav > li.current-menu-ancestor > a {
			" . cmsmasters_color_css('color', $cmsmasters_option['charity-ngo' . '_header_top_title_link_hover']) . "
		}
	}
	...
	@media only screen and (min-width: 1025px) {
		ul.top_line_nav > li > a {
			" . cmsmasters_color_css('background-color', $cmsmasters_option['charity-ngo' . '_header_top_title_link_bg']) . "
		}
	}
	...
	@media only screen and (min-width: 1025px) {
		...
		ul.top_line_nav > li.current-menu-item > a,
		ul.top_line_nav > li.current-menu-ancestor > a {
			" . cmsmasters_color_css('background-color', $cmsmasters_option['charity-ngo' . '_header_top_title_link_bg_hover']) . "
		}
	}
	...
	@media only screen and (min-width: 1025px) {
		ul.top_line_nav > li {
			" . cmsmasters_color_css('border-color', $cmsmasters_option['charity-ngo' . '_header_top_title_link_border']) . "
		}
	}
	...
	@media only screen and (max-width: 1024px) {
		ul.top_line_nav {
			" . cmsmasters_color_css('background-color', $cmsmasters_option['charity-ngo' . '_header_top_dropdown_bg']) . "
		}
	}
	...
	@media only screen and (min-width: 1025px) {
		ul.top_line_nav ul {
			" . cmsmasters_color_css('border-color', $cmsmasters_option['charity-ngo' . '_header_top_dropdown_border']) . "
		}
	}
	...
	.top_line_nav li a {
		" . cmsmasters_color_css('color', $cmsmasters_option['charity-ngo' . '_header_top_dropdown_link']) . "
	}
	...
	.top_line_nav li.current-menu-item > a {
		" . cmsmasters_color_css('color', $cmsmasters_option['charity-ngo' . '_header_top_dropdown_link_hover']) . "
	}
	...
	.top_line_nav li > a:hover,
	.top_line_nav li.current-menu-item > a {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['charity-ngo' . '_header_top_dropdown_link_highlight']) . "
	}
	...
	.top_line_nav li {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['charity-ngo' . '_header_top_dropdown_link_border']) . "
	}
...
";
	...
	return apply_filters('charity_ngo_theme_colors_secondary_filter', $custom_css);
}
