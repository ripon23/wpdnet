...
function charity_ngo_theme_colors_primary() {
...
/***************** Start {$title} Color Scheme Rules ******************/
	...
	{$rule}.custom_subscribe .wysija-input {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['charity-ngo' . '_' . $scheme . '_color']) . ", 0.08) !important;
	}
	
	{$rule}.cmsmasters_prev_arrow:hover, 
	{$rule}.cmsmasters_next_arrow:hover {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['charity-ngo' . '_' . $scheme . '_color']) . "
	}	
	...
	{$rule}.cmsmasters_post_footer .cmsmasters_post_read_more:hover,
	...
	{$rule}.bottom_inner .button:hover, 
	...
	{$rule}.cmsmasters_post_footer .cmsmasters_post_read_more,
	...
	{$rule}#mailpoet_form_1 .mailpoet_submit input[type=submit]:hover,
	...
	{$rule}.header_mid .search_wrap.search_opened .search_bar_wrap {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['charity-ngo' . '_' . $scheme . '_heading']) . ", 0.95);
	}
	
	{$rule}.cmsmasters_profile .cmsmasters_img_rollover_wrap:hover .cmsmasters_img_rollover {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['charity-ngo' . '_' . $scheme . '_heading']) . ", 0.8);
	}
	
	{$rule}.post.cmsmasters_puzzle_type .preloader:after {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['charity-ngo' . '_' . $scheme . '_heading']) . ", 0.6);
	}
	...
	{$rule}.cmsmasters_slider_post .cmsmasters_img_rollover .cmsmasters_theme_icon_post_link,
	...
	{$rule}.post.cmsmasters_puzzle_type .puzzle_post_content_wrapper:before {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['charity-ngo' . '_' . $scheme . '_bg']) . "
	}
	...
	{$rule}.custom_subscribe input:not([type=submit]):not([type=button]):not([type=radio]):not([type=checkbox]) {
		color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['charity-ngo' . '_' . $scheme . '_alternate']) . ", 0.5);
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['charity-ngo' . '_' . $scheme . '_alternate']) . ", 0.1);
		border-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['charity-ngo' . '_' . $scheme . '_alternate']) . ", 0.5);
	}
	
	{$rule}.custom_subscribe input:not([type=submit]):not([type=button]):not([type=radio]):not([type=checkbox])::-webkit-input-placeholder {
		color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['charity-ngo' . '_' . $scheme . '_alternate']) . ", 0.5);
	}
	
	{$rule}.custom_subscribe input:not([type=submit]):not([type=button]):not([type=radio]):not([type=checkbox]):-moz-placeholder {
		color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['charity-ngo' . '_' . $scheme . '_alternate']) . ", 0.5);
	}
	...
	{$rule}.widget .textwidget ul li a,
	{$rule}.widget .textwidget ol li a,
	{$rule}.cmsmasters_slider_post .cmsmasters_slider_post_inner, 
	{$rule}.cmsmasters_notice .notice_close, 
	...
	/* Start Custom Rules */
	{$rule}::selection {
		" . cmsmasters_color_css('background', $cmsmasters_option['charity-ngo' . '_' . $scheme . '_link']) . "
		" . cmsmasters_color_css('color', $cmsmasters_option['charity-ngo' . '_' . $scheme . '_bg']) . ";
	}
	...
	if ($scheme != 'default') {
		...
		.cmsmasters_color_scheme_{$scheme}.cmsmasters_row_bot_zigzag:after {
			background-image: -webkit-linear-gradient(135deg, " . $cmsmasters_option['charity-ngo' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-webkit-linear-gradient(45deg, " . $cmsmasters_option['charity-ngo' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: -moz-linear-gradient(135deg, " . $cmsmasters_option['charity-ngo' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-moz-linear-gradient(45deg, " . $cmsmasters_option['charity-ngo' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: -ms-linear-gradient(135deg, " . $cmsmasters_option['charity-ngo' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-ms-linear-gradient(45deg, " . $cmsmasters_option['charity-ngo' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: -o-linear-gradient(135deg, " . $cmsmasters_option['charity-ngo' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-o-linear-gradient(45deg, " . $cmsmasters_option['charity-ngo' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: linear-gradient(315deg, " . $cmsmasters_option['charity-ngo' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					linear-gradient(45deg, " . $cmsmasters_option['charity-ngo' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
		}
		";
	}
...
";
	...
	return apply_filters('charity_ngo_theme_colors_primary_filter', $custom_css);
}
