...
add_action('admin_menu', 'charity_ngo_add_menu');
add_action('admin_init', 'charity_ngo_register_settings');
...
function charity_ngo_get_settings() {
	$output = array();
	
	
	$page = charity_ngo_get_admin_page();
	...
	case 'cmsmasters-settings':
		$cmsmasters_option_name = 'cmsmasters_options_' . 'charity-ngo';
		$cmsmasters_settings_page_title = esc_html__('Theme General Settings', 'charity-ngo');
		$cmsmasters_page_sections = apply_filters('cmsmasters_options_general_sections_filter', charity_ngo_options_general_sections(), $tab);
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_general_fields_filter', charity_ngo_options_general_fields(), $tab);
		$cmsmasters_page_tabs = apply_filters('cmsmasters_options_general_tabs_filter', charity_ngo_options_general_tabs());
	...
	case 'cmsmasters-settings' . '-font':
		$cmsmasters_option_name = 'cmsmasters_options_' . 'charity-ngo' . '_font';
		$cmsmasters_settings_page_title = esc_html__('Theme Fonts Settings', 'charity-ngo');
		$cmsmasters_page_sections = apply_filters('cmsmasters_options_font_sections_filter', charity_ngo_options_font_sections(), $tab);
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_font_fields_filter', charity_ngo_options_font_fields(), $tab);
		$cmsmasters_page_tabs = apply_filters('cmsmasters_options_font_tabs_filter', charity_ngo_options_font_tabs());
	...
	case 'cmsmasters-settings' . '-color':
		$cmsmasters_option_name = 'cmsmasters_options_' . 'charity-ngo' . '_color';
		$cmsmasters_settings_page_title = esc_html__('Theme Color Schemes', 'charity-ngo');
		$cmsmasters_page_sections = charity_ngo_options_color_sections();
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_color_fields_filter', charity_ngo_options_color_fields(), $tab);
		$cmsmasters_page_tabs = charity_ngo_options_color_tabs();
	...
	case 'cmsmasters-settings' . '-element':
		$cmsmasters_option_name = 'cmsmasters_options_' . 'charity-ngo' . '_element';
		$cmsmasters_settings_page_title = esc_html__('Theme Elements Settings', 'charity-ngo');
		$cmsmasters_page_sections = apply_filters('cmsmasters_options_element_sections_filter', charity_ngo_options_element_sections(), $tab);
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_element_fields_filter', charity_ngo_options_element_fields(), $tab);
		$cmsmasters_page_tabs = apply_filters('cmsmasters_options_element_tabs_filter', charity_ngo_options_element_tabs());
	...
	case 'cmsmasters-settings' . '-single':
		$cmsmasters_option_name = 'cmsmasters_options_' . 'charity-ngo' . '_single';
		$cmsmasters_settings_page_title = esc_html__('Theme Single Posts Settings', 'charity-ngo');
		$cmsmasters_page_sections = apply_filters('cmsmasters_options_single_sections_filter', charity_ngo_options_single_sections(), $tab);
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_single_fields_filter', charity_ngo_options_single_fields(), $tab);
		$cmsmasters_page_tabs = apply_filters('cmsmasters_options_single_tabs_filter', charity_ngo_options_single_tabs());
	...
	case 'cmsmasters-settings' . '-demo':
		$cmsmasters_option_name = 'cmsmasters_options_' . 'charity-ngo' . '_demo';
		$cmsmasters_settings_page_title = esc_html__('Theme Settings Import/Export', 'charity-ngo');
		$cmsmasters_page_sections = charity_ngo_options_demo_sections();
		$cmsmasters_page_fields = charity_ngo_options_demo_fields();
		$cmsmasters_page_tabs = charity_ngo_options_demo_tabs();
...
function charity_ngo_create_settings_field($args = array()) {
	$defaults = array( 
		'id' => 		'default_field', 
		'title' => 		esc_html__('Default Field', 'charity-ngo'), 
		'desc' => 		esc_html__('This is a default description.', 'charity-ngo'), 
		'std' => 		'', 
		'type' => 		'text', 
...
function charity_ngo_register_settings() {
	$settings_output = charity_ngo_get_settings();
	...
	register_setting($cmsmasters_option_name, $cmsmasters_option_name, 'charity_ngo_validate_options');
	
	
	if (!empty($settings_output['cmsmasters_page_sections'])) {
		foreach ($settings_output['cmsmasters_page_sections'] as $id => $title) {
			add_settings_section($id, $title, 'charity_ngo_section_fn', __FILE__);
		}
	}
	...
	if (!empty($settings_output['cmsmasters_page_fields'])) {
		foreach ($settings_output['cmsmasters_page_fields'] as $option) {
			charity_ngo_create_settings_field($option);
		}
	}
...
function charity_ngo_settings_scripts() {
	wp_enqueue_style('wp-jquery-ui-dialog');
	
	
	wp_enqueue_style('charity-ngo-settings-css', get_template_directory_uri() . '/framework/admin/settings/css/cmsmasters-theme-settings.css', array(), '1.0.0', 'screen');
	
	
	if (is_rtl()) {
		wp_enqueue_style('charity-ngo-settings-css-rtl', get_template_directory_uri() . '/framework/admin/settings/css/cmsmasters-theme-settings-rtl.css', array(), '1.0.0', 'screen');
	}
	...
	wp_enqueue_script('charity-ngo-settings-js', get_template_directory_uri() . '/framework/admin/settings/js/cmsmasters-theme-settings.js', array('jquery', 'farbtastic'), '1.0.0', true);
	
	wp_localize_script('charity-ngo-settings-js', 'cmsmasters_setting', array( 
		'palettes' => 			implode(',', cmsmasters_color_picker_palettes()), 
		'remove' => 			esc_attr__('Remove', 'charity-ngo'), 
		'remove_sidebar' => 	esc_html__('Do you realy want to remove this sidebar?', 'charity-ngo'), 
		'find' => 				esc_attr__('Find icons', 'charity-ngo'), 
		'remove_icon' => 		esc_html__('Do you realy want to remove this social icon?', 'charity-ngo'), 
		'theme_uri' => 			get_template_directory_uri(), 
		'shortname' => 			'charity-ngo', 
		'done' => 				esc_html__('All theme settings were imported successfully.', 'charity-ngo'), 
		'fail' => 				esc_html__("Error on page!!!\nPlease reload page and try again.", 'charity-ngo'), 
	...
	wp_enqueue_script('charity-ngo-settings-js-toggle', get_template_directory_uri() . '/framework/admin/settings/js/cmsmasters-theme-settings-toggle.js', array('jquery'), '1.0.0', true);
	
	wp_localize_script('charity-ngo-settings-js-toggle', 'cmsmasters_settings', array( 
		'shortname' => 	'charity-ngo' 
	));
...
function charity_ngo_add_menu() {
	...
	$add_menu_p( 
		esc_attr__('Theme Settings', 'charity-ngo'), 
		esc_attr__('Theme Settings', 'charity-ngo'), 
		'manage_options', 
		'cmsmasters-settings', 
		'charity_ngo_settings_page_fn', 
		'' 
	);
	...
	$cmsmasters_settings_general = $add_submenu_p( 
		'cmsmasters-settings', 
		esc_attr__('Theme General Settings', 'charity-ngo'), 
		esc_attr__('General', 'charity-ngo'), 
		'manage_options', 
		'cmsmasters-settings', 
		'charity_ngo_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_general, 'charity_ngo_settings_scripts');
	
	
	$cmsmasters_settings_font = $add_submenu_p( 
		'cmsmasters-settings', 
		esc_attr__('Theme Fonts Settings', 'charity-ngo'), 
		esc_attr__('Fonts', 'charity-ngo'), 
		'manage_options', 
		'cmsmasters-settings' . '-font', 
		'charity_ngo_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_font, 'charity_ngo_settings_scripts');
	
	
	$cmsmasters_settings_color = $add_submenu_p( 
		'cmsmasters-settings', 
		esc_attr__('Theme Color Schemes', 'charity-ngo'), 
		esc_attr__('Colors', 'charity-ngo'), 
		'manage_options', 
		'cmsmasters-settings' . '-color', 
		'charity_ngo_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_color, 'charity_ngo_settings_scripts');
	
	
	$cmsmasters_settings_element = $add_submenu_p( 
		'cmsmasters-settings', 
		esc_attr__('Theme Elements Settings', 'charity-ngo'), 
		esc_attr__('Elements', 'charity-ngo'), 
		'manage_options', 
		'cmsmasters-settings' . '-element', 
		'charity_ngo_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_element, 'charity_ngo_settings_scripts');
	
	
	$cmsmasters_settings_single = $add_submenu_p( 
		'cmsmasters-settings', 
		esc_attr__('Theme Single Posts Settings', 'charity-ngo'), 
		esc_attr__('Single Posts', 'charity-ngo'), 
		'manage_options', 
		'cmsmasters-settings' . '-single', 
		'charity_ngo_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_single, 'charity_ngo_settings_scripts');
	
	
	$cmsmasters_settings_demo = $add_submenu_p( 
		'cmsmasters-settings', 
		esc_attr__('Theme Settings Import/Export', 'charity-ngo'), 
		esc_attr__('Import/Export', 'charity-ngo'), 
		'manage_options', 
		'cmsmasters-settings' . '-demo', 
		'charity_ngo_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_demo, 'charity_ngo_settings_scripts');
}


function charity_ngo_section_fn($desc) {
	$tab = charity_ngo_get_the_tab();
...
function charity_ngo_settings_page_fn() {
	$settings_output = charity_ngo_get_settings();
	$current_tab = charity_ngo_get_the_tab();
	
	echo '<div class="wrap">';
	
	charity_ngo_settings_page_header();
	...
	if ($current_tab != 'wpml') {
		...
		'<p class="submit-top">' . 
			(($current_tab != 'import' && $current_tab != 'export') ? '<input name="submit-top" type="submit" class="button button-primary button-large" value="' . esc_attr__('Save Changes', 'charity-ngo') . '" />' : '') . 
		'</p>';
		...
		echo '<p class="submit">' . 
				(($current_tab != 'import' && $current_tab != 'export') ? '<input name="submit" type="submit" class="button button-primary button-large" value="' . esc_attr__('Save Changes', 'charity-ngo') . '" />' : (($current_tab == 'import') ? '<input name="import" type="button" class="button button-primary button-large cmsmasters-demo-import" value="' . esc_attr__('Import Settings', 'charity-ngo') . '" />' : '')) . 
			'</p>' . 
		'</form>';
	} else {
		do_settings_sections(__FILE__);
...
function charity_ngo_form_field_fn($args = array()) {
	extract($args);
	...
	case 'upload':
		...
		echo '<div class="cmsmasters_upload_parent cmsmasters_select_parent">' . 
			'<input type="button" id="cmsmasters_upload_' . $id . '_button" class="cmsmasters_upload_button button button-large" value="' . esc_attr__('Choose Image', 'charity-ngo') . '" data-title="' . esc_attr__('Choose Image', 'charity-ngo') . '" data-button="' . esc_attr__('Insert Image', 'charity-ngo') . '" data-id="cmsmasters-media-select-frame-' . $id . '" data-classes="media-frame cmsmasters-media-select-frame' . ((!isset($description)) ? ' cmsmasters-frame-no-description' : '') . ((!isset($caption)) ? ' cmsmasters-frame-no-caption' : '') . ((!isset($align)) ? ' cmsmasters-frame-no-align' : '') . ((!isset($link)) ? ' cmsmasters-frame-no-link' : '') . ((!isset($size)) ? ' cmsmasters-frame-no-size' : '') . '" data-library="image" data-type="' . $frame . '"' . (($frame == 'post') ? ' data-state="insert"' : '') . ' data-multiple="' . $multiple . '" />' . 
			'<div class="cmsmasters_upload"' . (($image != '') ? ' style="display:block;"' : '') . '>' . 
				'<img src="' . (($image != '') ? $image : '') . '" class="cmsmasters_preview_image" alt="" />' . 
				'<a href="#" class="cmsmasters_upload_cancel admin-icon-remove" title="' . esc_attr__('Remove', 'charity-ngo') . '"></a>' . 
			'</div>' . 
	...
	case 'typorgaphy':
		...
		if ($system_font) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				foreach (charity_ngo_system_fonts_list() as $key => $value) {
					echo '<option value="' . esc_attr($key) . '"' . (($options[$id . '_system_font'] == $key) ? ' selected="selected"' : '') . '>' . esc_html($value) .'</option>';
				}
				
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_system_font">' . esc_html__('System Font', 'charity-ngo') . '</label>' . 
			'</div>';
		}
		...
		if ($google_font) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_google_font">' . esc_html__('Google Font', 'charity-ngo') . '</label>' . 
			'</div>';
		}
		...
		if ($font_size) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				' &nbsp; ' . 
				'<label for="' . $id . '_font_size_number">' . esc_html__('Font Size', 'charity-ngo') . ' <em>(' . esc_html__('in pixels', 'charity-ngo') . ')</em></label>' . 
			'</div>';
		}
		...
		if ($line_height) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				' &nbsp; ' . 
				'<label for="' . $id . '_line_height_number">' . esc_html__('Line Height', 'charity-ngo') . ' <em>(' . esc_html__('in pixels', 'charity-ngo') . ')</em></label>' . 
			'</div>';
		}
		...
		if ($font_weight) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_font_weight">' . esc_html__('Font Weight', 'charity-ngo') . '</label>' . 
			'</div>';
		}
		...
		if ($font_style) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_font_style">' . esc_html__('Font Style', 'charity-ngo') . '</label>' . 
			'</div>';
		}
		...
		if ($text_transform) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				foreach (charity_ngo_text_transform_list() as $key => $value) {
					echo '<option value="' . esc_attr($key) . '"' . (($options[$id . '_text_transform'] == $key) ? ' selected="selected"' : '') . '>' . esc_html($value) .'</option>';
				}
				
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_text_transform">' . esc_html__('Text Transform', 'charity-ngo') . '</label>' . 
			'</div>';
		}
		...
		if ($text_decoration) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				foreach (charity_ngo_text_decoration_list() as $key => $value) {
					echo '<option value="' . esc_attr($key) . '"' . (($options[$id . '_text_decoration'] == $key) ? ' selected="selected"' : '') . '>' . esc_html($value) .'</option>';
				}
				
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_text_decoration">' . esc_html__('Text Decoration', 'charity-ngo') . '</label>' . 
			'</div>';
		}
	...
	case 'sidebar':
		...
		'<div class="sidebar_management">' . 
			'<p>' . 
				...
				'<input class="button" type="button" id="add_sidebar" value="' . esc_attr__('Add Sidebar', 'charity-ngo') . '" />' . 
			'</p>' . 
			'<div></div>' . 
			'<ul>';
	...
	case 'social':
		...
		'<div class="icon_management">' . 
			'<p>' . 
				...
				'<input id="' . $id . '_button" class="cmsmasters_icon_choose_button button" type="button" value="' . esc_attr__('Choose icon', 'charity-ngo') . '" />' . 
				'<a href="#" class="cmsmasters_remove_icon admin-icon-remove" title="' . esc_attr__('Cancel changes', 'charity-ngo') . '"></a>' . 
			'</p>' . 
			'<span class="cl"><br /></span>' . 
			'<span class="icon_upload_link" style="display:none;">' . 
				'<label for="new_icon_color">' . 
					'<span class="cmsmasters_col_label">' . esc_html__('Icon Color', 'charity-ngo') . '</span>' . 
				...
				'<label for="new_icon_hover">' . 
					'<span class="cmsmasters_col_label">' . esc_html__('Icon Hover Color', 'charity-ngo') . '<br /><em>' . esc_html__('if not selected - Icon Color will be used', 'charity-ngo') . '</em></span>' . 
				...
				'<label for="new_icon_link">' . 
					...
					esc_html__('Icon Link', 'charity-ngo') . 
				'</label>' . 
				'<label for="new_icon_title">' . 
					'<input class="all-options" type="text" id="new_icon_title" /> ' . 
					esc_html__('Icon Title', 'charity-ngo') . 
				'</label>' . 
				'<label for="new_icon_target">' . 
					'<input type="checkbox" id="new_icon_target" value="true" /> ' . 
					esc_html__('Open link in a new tab/window?', 'charity-ngo') . 
				'</label>' . 
			'</span>' . 
			'<span class="cl"></span>' . 
			'<input class="button button-primary" type="button" id="add_icon" value="' . esc_attr__('Add Icon', 'charity-ngo') . '" />' . 
			'<input class="button button-primary" type="button" id="edit_icon" value="' . esc_attr__('Save Icon', 'charity-ngo') . '" />' . 
			'<ul>';
			...
			if (isset($options[$id]) && is_array($options[$id])) {
				foreach($options[$id] as $icon) {
					...
					echo '<li>' . 
						...
						'</div>' . 
						'<a href="#" class="icon_del admin-icon-remove" title="' . esc_attr__('Remove', 'charity-ngo') . '"></a> ' . 
...
function charity_ngo_validate_options($input) {
	$valid_input = array();
	...
	foreach ($options as $option) {
		...
		case 'text':
			...
			case 'numeric':
				...
				$valid_input[$option['id']] = (is_numeric($input[$option['id']])) ? $input[$option['id']] : esc_html__('Expecting a Numeric value!', 'charity-ngo');
				
				if (is_numeric($input[$option['id']]) == false) {
					add_settings_error(
						$option['id'],
						'charity-ngo' . '_txt_numeric_error',
						esc_html__('Expecting a Numeric value! Please fix.', 'charity-ngo'),
						'error'
					);
				}
			...
			case 'multinumeric':
				...
				if ($input[$option['id']] != '') {
					$valid_input[$option['id']] = (preg_match('/^-?\d+(?:,\s?-?\d+)*$/', $input[$option['id']]) == 1) ? $input[$option['id']] : esc_html__('Expecting comma separated numeric values', 'charity-ngo');
				} else {
				...
				if ($input[$option['id']] != '' && preg_match('/^-?\d+(?:,\s?-?\d+)*$/', $input[$option['id']]) != 1) {
					add_settings_error(
						$option['id'],
						'charity-ngo' . '_txt_multinumeric_error',
						esc_html__('Expecting comma separated numeric values! Please fix.','charity-ngo'),
						'error'
					);
				}
			...
			case 'email':
				...
				if ($input[$option['id']] != '') {
					$valid_input[$option['id']] = (is_email($input[$option['id']]) !== false) ? $input[$option['id']] : esc_html__('Invalid email! Please re-enter!', 'charity-ngo');
				} elseif ($input[$option['id']] == '') {
					$valid_input[$option['id']] = esc_html__('This setting field cannot be empty! Please enter a valid email address.', 'charity-ngo');
				}
				
				if (is_email($input[$option['id']]) == false || $input[$option['id']] == '') {
					add_settings_error(
						$option['id'],
						'charity-ngo' . '_txt_email_error',
						esc_html__('Please enter a valid email address.', 'charity-ngo'),
						'error'
					);
				}
		...
		case 'number':
			$input[$option['id']] = trim($input[$option['id']]);
			$valid_input[$option['id']] = (is_numeric($input[$option['id']])) ? $input[$option['id']] : esc_html__('Number!', 'charity-ngo');
...
function charity_ngo_show_msg($message, $msgclass = 'info') {
	echo '<div id="message" class="' . $msgclass . '">' . $message . '</div>';
}


function charity_ngo_admin_msgs() {
	global $pagenow;
	...
	if ($pagenow == 'admin.php' && current_user_can('manage_options') && $cmsmasters_settings_pg !== false && !empty($set_errors)) {
		if ($set_errors[0]['code'] == 'settings_updated' && isset($_GET['settings-updated'])) {
			charity_ngo_show_msg('<p><strong>' . $set_errors[0]['message'] . '</strong></p>', 'updated');
		} else {
			foreach ($set_errors as $set_error) {
				charity_ngo_show_msg('<p class="setting-error-message" title="' . esc_attr($set_error['setting']) . '">' . $set_error['message'] . '</p>', 'error');
			}
		}
	}
}

add_action('admin_notices', 'charity_ngo_admin_msgs');


function charity_ngo_add_global_options() {
	$cmsmasters_option_names = array( 
		array( 
			'cmsmasters_options_' . 'charity-ngo' . '_general', 
			charity_ngo_options_general_fields('general') 
		), 
		array( 
			'cmsmasters_options_' . 'charity-ngo' . '_bg', 
			charity_ngo_options_general_fields('bg') 
		), 
		array( 
			'cmsmasters_options_' . 'charity-ngo' . '_header', 
			charity_ngo_options_general_fields('header') 
		), 
		array( 
			'cmsmasters_options_' . 'charity-ngo' . '_content', 
			charity_ngo_options_general_fields('content') 
		), 
		array( 
			'cmsmasters_options_' . 'charity-ngo' . '_footer', 
			charity_ngo_options_general_fields('footer') 
		), 
		array( 
			'cmsmasters_options_' . 'charity-ngo' . '_font_content', 
			charity_ngo_options_font_fields('content') 
		), 
		array( 
			'cmsmasters_options_' . 'charity-ngo' . '_font_link', 
			charity_ngo_options_font_fields('link') 
		), 
		array( 
			'cmsmasters_options_' . 'charity-ngo' . '_font_nav', 
			charity_ngo_options_font_fields('nav') 
		), 
		array( 
			'cmsmasters_options_' . 'charity-ngo' . '_font_heading', 
			charity_ngo_options_font_fields('heading') 
		), 
		array( 
			'cmsmasters_options_' . 'charity-ngo' . '_font_other', 
			charity_ngo_options_font_fields('other') 
		), 
		array( 
			'cmsmasters_options_' . 'charity-ngo' . '_element_sidebar', 
			charity_ngo_options_element_fields('sidebar') 
		), 
		array( 
			'cmsmasters_options_' . 'charity-ngo' . '_element_icon', 
			charity_ngo_options_element_fields('icon') 
		), 
		array( 
			'cmsmasters_options_' . 'charity-ngo' . '_element_lightbox', 
			charity_ngo_options_element_fields('lightbox') 
		), 
		array( 
			'cmsmasters_options_' . 'charity-ngo' . '_element_sitemap', 
			charity_ngo_options_element_fields('sitemap') 
		), 
		array( 
			'cmsmasters_options_' . 'charity-ngo' . '_element_error', 
			charity_ngo_options_element_fields('error') 
		), 
		array( 
			'cmsmasters_options_' . 'charity-ngo' . '_element_code', 
			charity_ngo_options_element_fields('code') 
		), 
		array( 
		...
		array( 
			...
			charity_ngo_options_single_fields('post') 
		), 
		array( 
			'cmsmasters_options_' . 'charity-ngo' . '_single_project', 
			charity_ngo_options_single_fields('project') 
		), 
		array( 
			'cmsmasters_options_' . 'charity-ngo' . '_single_profile', 
			charity_ngo_options_single_fields('profile') 
		), 
		array( 
			'cmsmasters_options_' . 'charity-ngo' . '_single_campaign', 
			charity_ngo_options_single_fields('campaign') 
		)
	);
	...
	foreach (charity_ngo_all_color_schemes_list() as $key => $value) {
		array_push($cmsmasters_option_names, array( 
			'cmsmasters_options_' . 'charity-ngo' . '_color_' . $key, 
			charity_ngo_options_color_fields($key) 
		));
	}
		...
		if ($cmsmasters_option_name[1] !== '') {
			foreach ($cmsmasters_option_name[1] as $selected_option) {
				if ( 
					...
					$selected_option['id'] !== 'charity-ngo' . '_social_icons' 
				) {
...
function charity_ngo_get_global_options() {
	...
	foreach (charity_ngo_all_color_schemes_list() as $key => $value) {
		array_push($cmsmasters_option_names, 'cmsmasters_options_' . 'charity-ngo' . '_color_' . $key);
	}
