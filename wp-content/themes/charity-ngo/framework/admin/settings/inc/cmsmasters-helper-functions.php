...
function charity_ngo_get_admin_page() {
	global $pagenow;
...
function charity_ngo_default_tab() {
	$current_page = charity_ngo_get_admin_page();
...
function charity_ngo_get_the_tab() {
	global $pagenow;
	
	$default_tab = charity_ngo_default_tab();
...
function charity_ngo_settings_page_header() {
