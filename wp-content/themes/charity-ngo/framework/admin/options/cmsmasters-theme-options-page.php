...
if (!function_exists('charity_ngo_get_custom_page_meta_fields')) {
function charity_ngo_get_custom_page_meta_fields() {
	$cmsmasters_option = charity_ngo_get_global_options();
	
	
	$cmsmasters_global_layout = (isset($cmsmasters_option['charity-ngo' . '_layout']) && $cmsmasters_option['charity-ngo' . '_layout'] !== '') ? $cmsmasters_option['charity-ngo' . '_layout'] : 'r_sidebar';
	...
	$cmsmasters_global_header_overlaps = (isset($cmsmasters_option['charity-ngo' . '_header_overlaps']) && $cmsmasters_option['charity-ngo' . '_header_overlaps'] !== '') ? (($cmsmasters_option['charity-ngo' . '_header_overlaps'] == 1) ? 'true' : 'false') : 'false';
	...
	$custom_page_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Header Overlaps Content', 'charity-ngo'), 
		...
		array( 
			'label'	=> esc_html__('Disabled Heading Block', 'charity-ngo'), 
			'desc'	=> esc_html__('Use this checkbox to disable heading block', 'charity-ngo'), 
