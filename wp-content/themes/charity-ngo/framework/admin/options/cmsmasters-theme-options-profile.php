...
if (!function_exists('charity_ngo_get_custom_profile_meta_fields')) {
function charity_ngo_get_custom_profile_meta_fields() {
	...
	$cmsmasters_global_profile_post_title = (isset($cmsmasters_option['charity-ngo' . '_profile_post_title']) && $cmsmasters_option['charity-ngo' . '_profile_post_title'] !== '') ? (($cmsmasters_option['charity-ngo' . '_profile_post_title'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_profile_post_details_title = (isset($cmsmasters_option['charity-ngo' . '_profile_post_details_title']) && $cmsmasters_option['charity-ngo' . '_profile_post_details_title'] !== '') ? $cmsmasters_option['charity-ngo' . '_profile_post_details_title'] : '';
	
	$cmsmasters_global_profile_post_share_box = (isset($cmsmasters_option['charity-ngo' . '_profile_post_share_box']) && $cmsmasters_option['charity-ngo' . '_profile_post_share_box'] !== '') ? (($cmsmasters_option['charity-ngo' . '_profile_post_share_box'] == 1) ? 'true' : 'false') : 'true';
	...
	$tabs_array['cmsmasters_profile'] = array( 
		'label' => esc_html__('Profile', 'charity-ngo'), 
	...
	$custom_profile_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Profile Title', 'charity-ngo'), 
		...
		array( 
			'label'	=> esc_html__('Subtitle', 'charity-ngo'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Details Title', 'charity-ngo'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Social Icons', 'charity-ngo'), 
			'desc'	=> esc_html__('Add social icons for this profile', 'charity-ngo'), 
		...
		array( 
			'label'	=> esc_html__('Profile Info', 'charity-ngo'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 1 Title', 'charity-ngo'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 1', 'charity-ngo'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 2 Title', 'charity-ngo'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 2', 'charity-ngo'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 3 Title', 'charity-ngo'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 3', 'charity-ngo'), 
			'desc'	=> '', 
