...
if (!function_exists('charity_ngo_get_custom_tt_event_meta_fields')) {
function charity_ngo_get_custom_tt_event_meta_fields() {
	...
	$cmsmasters_global_tt_event_hours = (isset($cmsmasters_option['charity-ngo' . '_tt_event_hours']) && $cmsmasters_option['charity-ngo' . '_tt_event_hours'] !== '') ? (($cmsmasters_option['charity-ngo' . '_tt_event_hours'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_tt_event_hours_title = (isset($cmsmasters_option['charity-ngo' . '_tt_event_hours_title']) && $cmsmasters_option['charity-ngo' . '_tt_event_hours_title'] !== '') ? $cmsmasters_option['charity-ngo' . '_tt_event_hours_title'] : '';
	
	$cmsmasters_global_tt_event_details_title = (isset($cmsmasters_option['charity-ngo' . '_tt_event_details_title']) && $cmsmasters_option['charity-ngo' . '_tt_event_details_title'] !== '') ? $cmsmasters_option['charity-ngo' . '_tt_event_details_title'] : '';
	...
	$tabs_array['cmsmasters_tt_event'] = array( 
		'label' => esc_html__('Event', 'charity-ngo'), 
	...
	$custom_tt_event_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Event Hours', 'charity-ngo'), 
		...
		array( 
			'label'	=> esc_html__('Event Hours Title', 'charity-ngo'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Event Details Title', 'charity-ngo'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Event Details', 'charity-ngo'), 
			'desc'	=> '', 
