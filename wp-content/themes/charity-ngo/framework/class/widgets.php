...
class WP_Widget_Custom_Contact_Info extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	esc_html__('Your contact information', 'charity-ngo') 
		);
		...
		parent::__construct('custom-contact-info', esc_attr__('Contact Information', 'charity-ngo'), $widget_ops, $control_ops);
	}
	
	function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? esc_attr__('Contact Information', 'charity-ngo') : $instance['title'], $instance, $this->id_base);
    ...
    function form($instance) {
        ...
        ?>
        <p class="l_half">
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Title', 'charity-ngo'); ?>:<br />
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo esc_attr($title); ?>" />
            </label>
        </p>
        <p class="r_half">
            <label for="<?php echo esc_attr($this->get_field_id('name')); ?>"><?php esc_html_e('Name', 'charity-ngo'); ?>:<br />
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('name')); ?>" name="<?php echo esc_attr($this->get_field_name('name')); ?>" type="text" value="<?php echo esc_attr($name); ?>" />
            </label>
        </p>
        <p class="l_half">
            <label for="<?php echo esc_attr($this->get_field_id('url')); ?>"><?php esc_html_e('Website', 'charity-ngo'); ?>:<br />
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('url')); ?>" name="<?php echo esc_attr($this->get_field_name('url')); ?>" type="text" value="<?php echo esc_attr($url); ?>" />
            </label>
        </p>
        <p class="r_half">
            <label for="<?php echo esc_attr($this->get_field_id('email')); ?>"><?php esc_html_e('Email', 'charity-ngo'); ?>:<br />
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('email')); ?>" name="<?php echo esc_attr($this->get_field_name('email')); ?>" type="text" value="<?php echo esc_attr($email); ?>" />
            </label>
        </p>
        <p class="l_half">
            <label for="<?php echo esc_attr($this->get_field_id('phone')); ?>"><?php esc_html_e('Phone', 'charity-ngo'); ?>:<br />
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('phone')); ?>" name="<?php echo esc_attr($this->get_field_name('phone')); ?>" type="text" value="<?php echo esc_attr($phone); ?>" />
            </label>
        </p>
        <p class="r_half">
            <label for="<?php echo esc_attr($this->get_field_id('address')); ?>"><?php esc_html_e('Address', 'charity-ngo'); ?>:<br />
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('address')); ?>" name="<?php echo esc_attr($this->get_field_name('address')); ?>" type="text" value="<?php echo esc_attr($address); ?>" />
            </label>
        </p>
        <p class="l_half">
            <label for="<?php echo esc_attr($this->get_field_id('city')); ?>"><?php esc_html_e('City', 'charity-ngo'); ?>:<br />
        ...
        <p class="r_half">
            <label for="<?php echo esc_attr($this->get_field_id('state')); ?>"><?php esc_html_e('State', 'charity-ngo'); ?>:<br />
        ...
        <p class="l_half">
            <label for="<?php echo esc_attr($this->get_field_id('zip')); ?>"><?php esc_html_e('Zip', 'charity-ngo'); ?>:<br />
        ...
        <p class="r_half">
            <label for="<?php echo esc_attr($this->get_field_id('country')); ?>"><?php esc_html_e('Country', 'charity-ngo'); ?>:<br />
        ...
        <p class="l_half">
            <label for="<?php echo esc_attr($this->get_field_id('time')); ?>"><?php esc_html_e('Time', 'charity-ngo'); ?>:<br />
...
class WP_Widget_Custom_Latest_Projects extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	esc_attr__('Latest projects from your portfolio', 'charity-ngo') 
		);
		
		parent::__construct('custom-latest-projects', esc_attr__('Latest Projects', 'charity-ngo'), $widget_ops);
	}
	
    function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? esc_attr__('Latest Projects', 'charity-ngo') : $instance['title'], $instance, $this->id_base);
            ...
            while ($lp->have_posts()) : $lp->the_post();
				...
				echo '<div class="cmsmasters_owl_slider_item cmsmasters_widget_project">' . 
					'<div class="cmsmasters_widget_project_outer">';
						...
						charity_ngo_thumb_rollover(get_the_ID(), 'cmsmasters-blog-masonry-thumb', false, false, false, false, false, false, false, false, true, $cmsmasters_project_link_redirect, $cmsmasters_project_link_url);
						...
						echo '<div class="cmsmasters_widget_project_inner">';
							...
							echo '<div class="cmsmasters_widget_project_cont_info entry-meta">';
								...
								echo '<div class="cmsmasters_widget_project_footer entry-meta">';
									...
									charity_ngo_slider_post_like('project');
									
									charity_ngo_get_slider_post_comments('project');
									
								echo '</div>' . 
							'</div>';
							
							charity_ngo_slider_post_heading(get_the_ID(), 'project', 'h5', $cmsmasters_project_link_redirect, $cmsmasters_project_link_url);
							
							charity_ngo_slider_post_exc_cont('project');
							
							charity_ngo_slider_post_more(get_the_ID(), 'project');
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('type')); ?>"><?php esc_html_e('Show Only from Projects Type', 'charity-ngo'); ?>:<br />
                <select id="<?php echo esc_attr($this->get_field_id('type')); ?>" name="<?php echo esc_attr($this->get_field_name('type')); ?>" class="widefat">
                    <option value=""><?php esc_html_e('Show all projects', 'charity-ngo'); ?>&nbsp;</option>
				<?php 
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('number')); ?>"><?php esc_html_e("Enter the number of latest projects you'd like to display", 'charity-ngo'); ?>:<br /><br />
                <input id="<?php echo esc_attr($this->get_field_id('number')); ?>" name="<?php echo esc_attr($this->get_field_name('number')); ?>" type="text" value="<?php echo esc_attr($number); ?>" size="3" />
                <small class="s_red"><?php esc_html_e('default is', 'charity-ngo'); ?> 3</small><br />
            </label>
        </p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('autoplay')); ?>"><?php esc_html_e('Autoplay', 'charity-ngo'); ?></label>
		</p>
        <div class="cl"></div>
        <?php
    }
...
class WP_Widget_Custom_Popular_Projects extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	esc_attr__('Popular projects from your portfolio', 'charity-ngo') 
		);
		
		parent::__construct('custom-popular-projects', esc_attr__('Popular Projects', 'charity-ngo'), $widget_ops);
	}
	
    function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? esc_attr__('Popular Projects', 'charity-ngo') : $instance['title'], $instance, $this->id_base);
		$type = isset($instance['type']) ? $instance['type'] : '';
		$number = isset($instance['number']) ? (int) $instance['number'] : '';
        $autoplay = isset($instance['autoplay']) ? $instance['autoplay'] : false;
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('number')); ?>"><?php esc_html_e("Enter the number of popular projects you'd like to display", 'charity-ngo'); ?>:<br /><br />
                <input id="<?php echo esc_attr($this->get_field_id('number')); ?>" name="<?php echo esc_attr($this->get_field_name('number')); ?>" type="text" value="<?php echo esc_attr($number); ?>" size="3" />
                <small class="s_red"><?php esc_html_e('default is', 'charity-ngo'); ?> 3</small><br />
            </label>
        </p>
...
class WP_Widget_Custom_Posts_Tabs extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	esc_attr__('Latest, popular posts & recent comments', 'charity-ngo') 
		);
		
		parent::__construct('custom-posts-tabs', esc_attr__('Posts Tabs', 'charity-ngo'), $widget_ops);
	}
	...
	function widget($args, $instance) {
		...
		if ($latest) {
			echo '<li class="cmsmasters_tabs_list_item current_tab">' . 
				'<a href="#"><span>' . esc_html__('Latest', 'charity-ngo') . '</span></a>' . 
			'</li>'; 
		}
		
		if ($popular) {
			echo '<li class="cmsmasters_tabs_list_item' . ((!$latest) ? ' current_tab' : '') . '">' . 
				'<a href="#"><span>' . esc_html__('Popular', 'charity-ngo') . '</span></a>' . 
			'</li>'; 
		}
		
		if ($recent) {
			echo '<li class="cmsmasters_tabs_list_item' . ((!$latest && !$popular) ? ' current_tab' : '') . '">' . 
				'<a href="#"><span>' . esc_html__('Comments', 'charity-ngo') . '</span></a>' . 
			'</li>'; 
		}
				...
				while ($l->have_posts()) : $l->the_post();
					...
					if ($pt_format == 'image' || $pt_format == 'gallery') {
						...
						if (has_post_thumbnail()) {
							charity_ngo_thumb(get_the_ID(), 'cmsmasters-small-thumb', true, false, false, false, false, true, false);
							...
							foreach ($attachments as $attachment) { 
								if (!isset($att_counter) && $att_counter = true) { 
									charity_ngo_thumb(get_the_ID(), 'cmsmasters-small-thumb', true, false, false, false, false, true, $attachment->ID);
								}
							}
						} else {
			...
			if ($rcomments) { 
				...
				foreach ($rcomments as $comment) {
					...
					echo '<li>' . 
						...
						' ' . esc_html__('on', 'charity-ngo') . ' <a href="' . get_permalink($comment_post_ID) . '#comments" rel="bookmark">' . cmsmasters_title($comment_post_ID, false) . '</a>' . 
						'<small>' . 
							'<abbr class="published" title="' . esc_attr(get_the_time('d-m-Y')) . '">' . human_time_diff($comment_date, current_time('timestamp')) . ' ' . esc_html__('ago', 'charity-ngo') . '</abbr>' . 
						'</small>' . 
    ...
    function form($instance) {
		...
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('latest')); ?>"><?php esc_html_e('Latest Posts', 'charity-ngo'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('popular')); ?>"><?php esc_html_e('Popular Posts', 'charity-ngo'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('recent')); ?>"><?php esc_html_e('Recent Comments', 'charity-ngo'); ?></label>
		</p>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('number')); ?>"><?php esc_html_e("Enter the number of recent comments, popular and latest posts you'd like to display", 'charity-ngo'); ?>:<br /><br />
                <input id="<?php echo esc_attr($this->get_field_id('number')); ?>" name="<?php echo esc_attr($this->get_field_name('number')); ?>" type="text" value="<?php echo esc_attr($number); ?>" size="3" />
                <small class="s_red"><?php esc_html_e('default is', 'charity-ngo'); ?> 3</small><br />
            </label>
        </p>
...
class WP_Widget_Custom_Twitter extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	esc_attr__('Your Twitter account latest tweets', 'charity-ngo') 
		);
		
		parent::__construct('custom-twitter', esc_attr__('Twitter', 'charity-ngo'), $widget_ops);
	}
	
	function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? esc_attr__('Twitter', 'charity-ngo') : $instance['title'], $instance, $this->id_base);
		...
		if ($user != '') {
			...
			if ($tweets != '') {
				...
				foreach ($tweets as $t) {
					echo '<li>' . "\n" . 
						'<span class="tweet_time cmsmasters_theme_icon_user_twitter">' . human_time_diff($t['time'], current_time('timestamp')) . ' ' . esc_html__('ago', 'charity-ngo') . '</span>' . "\n" . 
				...
				echo '<div class="cmsmasters_notice cmsmasters_notice_error cmsmasters_theme_icon_cancel">' . "\n" . 
					'<div class="notice_content">' . "\n" . 
						'<p>' . esc_html__('Please add your Twitter API keys', 'charity-ngo') . ', ' . '<a target="_blank" href="http://docs.cmsmasters.net/admin2/twitter-functionality/">' . esc_html__('read more how', 'charity-ngo') . '</a></p>' . "\n" . 
					'</div>' . "\n" . 
				'</div>' . "\n";
			}
		}
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('user')); ?>"><?php esc_html_e('Twitter Username', 'charity-ngo'); ?>:<br />
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('number')); ?>"><?php esc_html_e("Enter the number of latest tweets you'd like to display", 'charity-ngo'); ?>:<br /><br />
                <input id="<?php echo esc_attr($this->get_field_id('number')); ?>" name="<?php echo esc_attr($this->get_field_name('number')); ?>" type="text" value="<?php echo esc_attr($number); ?>" size="3" />
                <small class="s_red"><?php esc_html_e('default is', 'charity-ngo'); ?> 3</small><br />
            </label>
        </p>
...
class WP_Widget_Custom_PayPalDonations extends WP_Widget {
		...
		echo $before_widget . 
			'<div class="cmsmasters_paypal_donations_widget">' . "\n";
				...
				echo '<div class="cmsmasters_paypal_donations">' . "\n" . 
					...
					'<span class="button">' . ($button_text ? esc_html($button_text) : esc_html__('Donate', 'charity-ngo')) . '</span>' . "\n" . 
				'</div>' . "\n" . 
			'</div>' . "\n" . 
		$after_widget;
    }
    ...
    public function form($instance) {
		$defaults = array(
			'title' => 			esc_attr__('Donate', 'charity-ngo'),
			'text' => 			'',
			'purpose' => 		'',
			'reference' => 		'',
			'amount' => 		'',
		...
		?>
		<p>
			<label for="<?php echo esc_attr($title_id); ?>"><?php esc_html_e('Title:', 'charity-ngo'); ?> 
		...
		<p>
			<label for="<?php echo esc_attr($text_id); ?>"><?php esc_html_e('Text:', 'charity-ngo'); ?> 
		...
		<p>
			<label for="<?php echo esc_attr($purpose_id); ?>"><?php esc_html_e('Purpose:', 'charity-ngo'); ?> 
		...
		<p>
			<label for="<?php echo esc_attr($reference_id); ?>"><?php esc_html_e('Reference:', 'charity-ngo'); ?> 
		...
		<p>
			<label for="<?php echo esc_attr($amount_id); ?>"><?php esc_html_e('Amount:', 'charity-ngo'); ?> 
		...
		<p>
			<label for="<?php echo esc_attr($button_text_id); ?>"><?php esc_html_e('Button Text:', 'charity-ngo'); ?> 
