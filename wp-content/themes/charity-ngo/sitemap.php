...
if ($cmsmasters_option['charity-ngo' . '_sitemap_nav']) { 
	echo '<h1>' . esc_html__('Website Pages', 'charity-ngo') . '</h1>';
...
if ($cmsmasters_option['charity-ngo' . '_sitemap_categs']) {
	echo '<div class="cmsmasters_divider solid"></div>' . 
	'<h1>' . esc_html__('Blog Archives by Categories', 'charity-ngo') . '</h1>' . 
...
if ($cmsmasters_option['charity-ngo' . '_sitemap_tags']) {
	$tags = get_tags(array( 
		'orderby' => 'name', 
		'order' => 'DESC' 
	));
	...
	echo '<div class="cmsmasters_divider solid"></div>' . 
	'<h1>' . esc_html__('Blog Archives by Tags', 'charity-ngo') . '</h1>' . 
...
if ($cmsmasters_option['charity-ngo' . '_sitemap_month']) {
	echo '<div class="cmsmasters_divider solid"></div>' . 
	'<h1>' . esc_html__('Blog Archives by Month', 'charity-ngo') . '</h1>' . 
	'<ul class="cmsmasters_sitemap_archive">';
...
if ($cmsmasters_option['charity-ngo' . '_sitemap_pj_categs']) {
	echo '<div class="cmsmasters_divider solid"></div>' . 
	'<h1>' . esc_html__('Portfolio Archives by Categories', 'charity-ngo') . '</h1>' . 
	'<ul class="cmsmasters_sitemap_category">';
...
if ($cmsmasters_option['charity-ngo' . '_sitemap_pj_tags']) {
	echo '<div class="cmsmasters_divider solid"></div>' . 
	'<h1>' . esc_html__('Portfolio Archives by Tags', 'charity-ngo') . '</h1>' . 
	'<ul class="cmsmasters_sitemap_archive">';
