...
<div id="tribe-events-content" class="tribe-events-single vevent hentry">
	...
	if ($published_events > 1) {
		echo '<aside id="tribe-events-sub-nav" class="post_nav cmsmasters_single_tribe_nav">';
			...
			tribe_the_prev_event_link('<span class="post_nav_sub">' . esc_html__('Previous', 'charity-ngo') . '<span class="post_nav_type"> ' . esc_html__('Event', 'charity-ngo') . ' </span>' . esc_html__('Link', 'charity-ngo') . '</span>%title%<span class="cmsmasters_prev_arrow"><span>');
			
			tribe_the_next_event_link('<span class="post_nav_sub">' . esc_html__('Next', 'charity-ngo') . '<span class="post_nav_type"> ' . esc_html__('Event', 'charity-ngo') . ' </span>' . esc_html__('Link', 'charity-ngo') . '</span>%title%<span class="cmsmasters_next_arrow"><span>');
