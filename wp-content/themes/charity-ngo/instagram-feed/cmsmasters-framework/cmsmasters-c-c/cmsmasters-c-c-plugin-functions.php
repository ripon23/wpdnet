...
/* Register JS Scripts */
function charity_ngo_instagram_feed_register_c_c_scripts() {
	global $pagenow;
	...
	if ( 
		...
		wp_localize_script('cmsmasters-c-c-instagram-feed-extend', 'cmsmasters_instagram_feed_shortcodes', array( 
			'instagram_feed_title' =>        		esc_attr__('Instagram Feed', 'charity-ngo'), 
			'id_instagram_feed_title' =>      		esc_attr__('User Id', 'charity-ngo'), 
			'id_instagram_feed_descr' =>       		esc_attr__('There may be several ids', 'charity-ngo') 
		));
	}
}

add_action('admin_enqueue_scripts', 'charity_ngo_instagram_feed_register_c_c_scripts');
