...
$more_text = ($more_text != '') ? $more_text : esc_html__('Load More Posts', 'charity-ngo');


$filter_text = ($filter_text != '') ? $filter_text : esc_html__('Filter', 'charity-ngo');


$filter_cats_text = ($filter_cats_text != '') ? $filter_cats_text : esc_html__('All Categories', 'charity-ngo');
