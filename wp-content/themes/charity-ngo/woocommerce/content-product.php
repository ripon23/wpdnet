		...
		<div class="cmsmasters_product_inner">
			...
			if (get_the_terms($product->id, 'product_cat')) {
				echo '<div class="cmsmasters_product_cat entry-meta">' . 
					charity_ngo_get_the_category_list($product->id, 'product_cat', ', ') . 
				'</div>';
			}
			?>
			...
			<?php
				charity_ngo_woocommerce_rating('cmsmasters_theme_icon_star_empty', 'cmsmasters_theme_icon_star_full');
			?>
			<div class="cmsmasters_product_info">
			<?php
				woocommerce_template_loop_price();
				
				charity_ngo_woocommerce_add_to_cart_button();
