...
class Cmsmasters_Donations {
	public function __construct() {
		define('CMSMASTERS_DONATIONS_VERSION', '1.2.2');
	...
	public function cmsmasters_donations_activation_compatibility() {
		if ( 
			...
			wp_die( 
				__("Your theme doesn't support CMSMasters Donations plugin. Please use appropriate CMSMasters theme.", 'cmsmasters_donations'), 
				__("Error!", 'cmsmasters_donations'), 
				array( 
					'back_link' => 	true 
				) 
			);
	...
	public function cmsmasters_donations_compatibility_warning() {
		echo "<div class=\"notice notice-warning is-dismissible\">
			<p><strong>" . __("CMSMasters Donations plugin was deactivated, because your theme doesn't support it. Please use appropriate CMSMasters theme.", 'cmsmasters_donations') . "</strong></p>
		</div>";
	}
}
