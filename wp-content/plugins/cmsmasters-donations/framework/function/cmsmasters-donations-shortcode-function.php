			...
			'<div class="cmsmasters_row_margin">' . "\n";
				...
				while ($query->have_posts()) : $query->the_post();
					...
					$out .= '<div class="cmsmasters_column ' . $columns_class . '">';
						$out .= cmsmasters_composer_ob_load_template('cmsmasters-donations/postType/donation/standard.php', $this->donations_atts);
					$out .= '</div>';
	...
	if ($query->have_posts()) :
		...
		'>' . "\n";
			...
			while ($query->have_posts()) : $query->the_post();
				...
				$out .= cmsmasters_composer_ob_load_template('cmsmasters-donations/postType/campaign/vertical.php', $this->campaign_atts);
			...
			">";
				...
				while ($query->have_posts()) : $query->the_post();
					...
					$out .= '<div class="cmsmasters_owl_slider_item">';
						...
						$out .= cmsmasters_composer_ob_load_template('cmsmasters-donations/postType/campaign/horizontal.php', $this->campaigns_atts);
